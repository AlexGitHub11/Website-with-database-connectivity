...
<h1> Witch table would you like to search </h1>
<a href="search_database.php" style="text-decoration: none;"> <button class="boxbutton"> Staff  </button></a>
<a href="serchdatabasestu.php" style="text-decoration: none;"> <button class="boxbutton"> Student </button></a>
